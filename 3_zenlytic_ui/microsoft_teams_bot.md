...
3. Scroll down to the "Tenant ID" section and you will find your tenant ID in the box

4. Send your tenant ID to paul@zenlytic.com to connect your Zenlytic workspace to your Teams workspace

Step 2: Access the Microsoft Teams Admin Center

1. Navigate to the Microsoft Teams Admin Center and log in using your admin credentials

Step 3: Upload the Zenlytic Bot

1. From the left-hand panel, select "Teams apps" > "Manage apps".
