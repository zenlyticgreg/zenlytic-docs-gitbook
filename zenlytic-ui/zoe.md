...
When Zoë creates queries, she doesn't do Text-to-SQL, she uses the governed measures and dimensions that are present in your Cognitive Layer. This guarantees that Zoë can _never_ lie to you. She may misunderstand what you are asking about, but you will always be able to see exactly what data she is pulling because you'll see the measures, dimensions, and filters she used in her query, which map 1:1 to the SQL query she creates.
