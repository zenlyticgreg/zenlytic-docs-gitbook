...
![Dashboard Filters 1](../assets/dashboard-filters-1.gif)
...
![Dashboard Filters 2](../assets/dashboard-filters-2.gif)
This same behavior is applied for the time period filter's default values as shown below.

![Dashboard Filters 3](../assets/dashboard-filters-3.gif)