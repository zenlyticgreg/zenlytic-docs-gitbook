...
- [Signed Embedding](../4_embedding/signed_embedding.md)
    ...
    * You can apply permissions for the signed url using row-based and column-based [access grants](../5_data_modeling/access_grants.md) that are added to the signed url when you request it. The signed URL is placed in the iframe, which is displayed in your application.
