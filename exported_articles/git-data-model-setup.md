...
![Git Data Model Setup 1 - You'll know you're looking at the right value if it starts with `git@`](/images/git-data-model-setup-1.png)
...
![Git Data Model Setup 1](/images/git-data-model-setup-1.png)
...
![Git Data Model Setup 2](/images/git-data-model-setup-2.png)

Now, copy the Deploy Key to your clipboard.

Next go to your git provider (in this example Github). Click on "Settings."

![Git Data Model Setup 3](/images/git-data-model-setup-3.png)

Next, click on "Deploy Keys."

![Git Data Model Setup 4](/images/git-data-model-setup-4.png)
...
![Git Data Model Setup 6](/images/git-data-model-setup-6.png)
