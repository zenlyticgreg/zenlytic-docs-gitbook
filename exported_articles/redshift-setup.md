...
![](images/Screenshot+2023-06-08+at+10.51.33+AM.png)In this example using Redshift Serverless, the host (privacy obscured) is `default.123456789.us-east-1.redshift-serverless.amazonaws.com:5439/dev`
...
![](images/Screenshot+2023-06-08+at+10.55.39+AM.png)In this example, the database is `dev`
