...
> This question type lets you find out which items users purchase together in the same order or basket.
...
![](images/Screen+Recording+2023-02-17+at+2.04.35+PM.gif)  
...
Then run the question, and you'll see the basket combinations and a few metrics. You can change the number of combinations in the baskets using the drop-down under "Additional settings."
