...
![Github Deploy Key 2](/images/github-deploy-key-2.png)
...
![Github Deploy Key 3](/images/github-deploy-key-3.png)
...
![Github Deploy Key 4](/images/github-deploy-key-4.png)

Then hit Copy Deploy Key.

![Github Deploy Key 5](/images/github-deploy-key-5.png)

Now that you have the deploy key copied return to Github and go to "Settings."

![Github Deploy Key 6](/images/github-deploy-key-6.png)

Then go to Deploy Keys in the left-hand menu.

![Github Deploy Key 7](/images/github-deploy-key-7.png)

Then, click "Add new" and give your deploy key a name. Finally, paste that SSH key and click "Add Key." 

![Github Deploy Key 8](/images/github-deploy-key-8.png)
...
![Github Deploy Key 9](/images/github-deploy-key-9.png)
