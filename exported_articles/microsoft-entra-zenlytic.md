...
![Image - Your form should look similar to this:](/images/image.png)
...
![Image - Click on each of the claims under `Additional Claims`, and clear out the `Namespace` value](/images/image.png)
...
![Image - ptional step](#h_43bf0cfebb)
