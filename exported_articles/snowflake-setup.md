...
![Snowflake Setup 1](/images/snowflake-setup-1.png)
...
![Snowflake Setup 2](/images/snowflake-setup-2.png)
...
![Snowflake Setup 3](/images/snowflake-setup-3.png)
...
Advanced settings in Snowflake deal with situations where you're running analysis directly on data you've received via a Snowflake Share. Since Zenlytic uses Temporary Tables for functionality like [Explain Change](/articles/6927539-explain-change), you'll need to specify a Zenlytic database and schema Zenlytic will use to manifest temporary tables. To fulfill this requirement, you can create any database and schema with nothing in them.
