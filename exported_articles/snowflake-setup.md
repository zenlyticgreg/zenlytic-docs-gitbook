...
![](images/Screenshot+2023-06-08+at+10.12.54+AM.png)In this example, you'd enter `blah12345.us-east-1` for your account.
...
![](images/Screenshot+2023-06-08+at+10.08.33+AM.png)In this example, the username is `pblankley` 
...
![](images/Screenshot+2023-06-08+at+10.16.51+AM.png)In this example, we'll use the `REPORT_WH` warehouse.
...
![](images/Screenshot+2023-06-08+at+10.16.51+AM.png)In this example, we're using the `ZENLYTIC` database.
...
![](images/Screenshot+2023-06-08+at+10.16.51+AM.png)In this example, we're using the `REPORTER` role. Note: if the role you select doesn't have access to certain data in your warehouse, Zenlytic will be unable to access that data as well.
...
Advanced settings in Snowflake deal with situations where you're running analysis directly on data you've received via a Snowflake Share. Since Zenlytic uses Temporary Tables for functionality like [Explain Change](https://intercom.help/zenlytic/en/articles/6927539-explain-change), you'll need to specify a Zenlytic database and schema Zenlytic will use to manifest temporary tables. To fulfill this requirement, you can create any database and schema with nothing in them.
