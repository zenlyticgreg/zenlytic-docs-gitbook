...
![](images/Screenshot+2025-02-23+at+3_28_51%E2%80%AFPM.png)In this example using MySQL hosted on RDS, the host (privacy obscured) is `mysql-behind-ssh-tunnel.blahblahblah.us-east-1.rds.amazonaws.com`
