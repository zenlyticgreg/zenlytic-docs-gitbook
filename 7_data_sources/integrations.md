...
The metrics layer (obviously) integrates with [Zenlytic's own data model](/5_data_modeling/data_modeling.md) as the Cognitive layer, and dbt's semantic layer with [Metricflow](https://docs.getdbt.com/docs/build/sl-getting-started). The metrics layer supports versions 1.8 - 1.10 of dbt's semantic layer (Metricflow). More details on the integration can be found [here](/5_data_modeling/dbt_metricflow.md).
